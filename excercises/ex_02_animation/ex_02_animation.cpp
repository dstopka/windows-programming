...
// ex_02_animation.cpp : Defines the class behaviors for the application.
//
...
CanimationApp::CanimationApp()
{
	...
	SetAppID(_T("ex_02_animation.AppID.NoVersion"));
...
BOOL CanimationApp::InitInstance()
{
	...
	m_pMainWnd->SetWindowText( L"Stopka Dariusz Ball Animation" );
