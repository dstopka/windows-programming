...
void CanimationDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CanimationDoc::InitializeSearchContent()
{
...
void CanimationDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
